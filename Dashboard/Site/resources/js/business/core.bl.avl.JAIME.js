    ...
    this.Window = {
        ...
        AverageTime: {
                    ...
                    if (busStopLayer.visible) {
                        ...
                        geometryService.buffer(params, function (geometries) {
                            ...
                            queryTask.execute(query, function (data) {
                                ...
                                if (averageTime < 60)
                                    $('#' + avlBL.Window.AverageTime.Controls.Message).html(averageTime + ' segundos');
                                else
                                    $('#' + avlBL.Window.AverageTime.Controls.Message).html(new Number((averageTime / 60)).toFixed(2) + ' minutos');
                            },
                            function (err, a, b) {
            ...
            Controls: {
                ...
                Message: 'averageTimeSpan'
            },
            Show: function () {

                ///The content
                var content = '<input style="width:100%" type="checkbox" id="' + avlBL.Window.AverageTime.Controls.Button + '" /><label for="' + avlBL.Window.AverageTime.Controls.Button + '">' + busStopLayer._params.label + '</label><br/>Habilite a camada de Pontos de ônibus, e clique para consultar o tempo médio de espera<br/><br/>' +
                              'Tempo médio: <span id="' + avlBL.Window.AverageTime.Controls.Message + '" style="font-weight: bold"/>';

                ///The post function
                var postFunction = function () {

                    $('#' + avlBL.Window.AverageTime.Controls.Button)
                        .button()
                ...
                ///Show the window
                layoutUtils.make('averageTimeWindow', 'Tempo Médio', content, options, postFunction);
